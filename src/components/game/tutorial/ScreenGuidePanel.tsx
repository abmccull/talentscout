...
export function ScreenGuidePanel() {
  ...
  }, [activeScreenGuide, screenGuideStep, step]);

  useEffect(() => {
    if (activeScreenGuide != null && step == null) {
      closeScreenGuide();
    }
  }, [activeScreenGuide, step, closeScreenGuide]);
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5">
        <>
          <h2 id="screen-guide-title" className="mb-2 text-sm font-bold text-white">
            {step.title}
          </h2>
